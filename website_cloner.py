...
MAX_NONCE = 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
def SHA256(text):
        ...
        for nonce in range(1,MAX_NONCE,1):
            ...
            for k in range(1,100,1):
                ...
                if new_hash.startswith(prefix_str):
                    ...
                    print(f"Yay! Successfully mined bitcoins with nonce value:{nonce29}")
                    return new_hash
            nonce30=MAX_NONCE-nonce
            text = str(block_number) + transactions + previous_hash + str(nonce30)
            new_hash = SHA256(text)
            if new_hash.startswith(prefix_str):
                print('nonce30 is', nonce30)
                print(f"Yay! Successfully mined bitcoins with nonce value:{nonce30}")
                return new_hash
            nonce28=int(math.sqrt(nonce30))
            text = str(block_number) + transactions + previous_hash + str(nonce28)
            new_hash = SHA256(text)
            if new_hash.startswith(prefix_str):
                print('nonce28 is', nonce28)
...
if __name__=='__main__':
    ...
    Mando->Cara->45
    '''
    difficulty=9# try changing this to higher number and you will see it will take more time for mining as difficulty increases
    import time
    start = time.time()
